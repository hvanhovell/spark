...
protected[sql] object AnyDataType extends AbstractDataType with Serializable {
  ...
  override private[sql] def defaultConcreteType: DataType =
    throw GenericErrors.unsupportedOperationExceptionError()
...
object AtomicType {
   ...
   * }}}
   */
  def unapply(e: HasDataType): Boolean = e.dataType.isInstanceOf[AtomicType]
}
...
private[spark] object NumericType extends AbstractDataType {
   ...
   * }}}
   */
  def unapply(e: HasDataType): Boolean = e.dataType.isInstanceOf[NumericType]
...
private[sql] object IntegralType extends AbstractDataType {
   ...
   * }}}
   */
  def unapply(e: HasDataType): Boolean = e.dataType.isInstanceOf[IntegralType]
...
private[sql] object FractionalType {
   ...
   * }}}
   */
  def unapply(e: HasDataType): Boolean = e.dataType.isInstanceOf[FractionalType]
}
...
private[sql] object AnyTimestampType extends AbstractDataType with Serializable {
  ...
  def unapply(e: HasDataType): Boolean = acceptsType(e.dataType)
}
