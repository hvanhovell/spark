...
object ResolveDefaultColumns {
  val CURRENT_DEFAULT_COLUMN_METADATA_KEY: String = StructField.CURRENT_DEFAULT_COLUMN_METADATA_KEY
  val EXISTS_DEFAULT_COLUMN_METADATA_KEY: String = StructField.EXISTS_DEFAULT_COLUMN_METADATA_KEY
