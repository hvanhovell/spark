...
import org.apache.spark.sql.types.{ArrayType, BinaryType, DataType, Decimal, MapType, StringType, UserDefinedType}
...
class RowUtils {
  ...
  /**
   * Create the pretty (i.e. indented) JSON representation of a row.
   * @since 3.0
   */
  @Unstable
